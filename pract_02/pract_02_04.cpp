...
int main() {
    ...
    cout << endl;
    cout << inputMatrixTwo.det() << " " << inputMatrixTwo.isDiag() << " " << inputMatrixTwo.isUpperTriangle() << " " << inputMatrixTwo.isDownTriangle() << endl;
}